    ...
    <div class="text-vertical-center">
        ...
        <g:if test="${session.user}">
            <h3>¡Hola ${session.user.firstName} ${session.user.lastName}!
                <br>Lo sentimos, la pagina a la que intenta acceder es inaccesible.</h3>
            <br>
        </g:if>
        <g:else>
            <h3>Lo sentimos, la pagina a la que intenta acceder es inaccesible.</h3>
            <br>
        </g:else>
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="http://localhost:9090/PreventRisk" class="btn btn-dark btn-lg">Volver</a>
            </div>
        </div>
    </div>
</header>
