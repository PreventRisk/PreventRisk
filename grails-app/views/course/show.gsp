	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.progress}">
				<li class="fieldcontain">
					<span id="progress-label" class="property-label"><g:message code="course.progress.label" default="Progress" /></span>
					
						<span class="property-value" aria-labelledby="progress-label"><g:fieldValue bean="${courseInstance}" field="progress"/></span>
