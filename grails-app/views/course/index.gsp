...
<g:if test="${!session.user}">
	<header id="top" class="header">
		<div class="text-vertical-center">
			...
			<h3>Para ingresar al curso primero debe iniciar sesión.</h3>
			<br>
			<div class="row">
	...
	<section id="services" class="header">
		<div class="container">
			...
			<center><div class="service-item">
				<img src="${request.contextPath}/stylish/img/preventrisk-w.png" width="200px" height="auto" />
				<h3>¡Bienvenido al curso, ${session.user.firstName} ${session.user.lastName}!</h3>
			</div></center>
			<div class="transbox">
